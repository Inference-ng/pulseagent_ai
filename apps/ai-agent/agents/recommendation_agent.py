    ...
    if not state["candidate_products"]:
        ...
        DOMAIN_FALLBACK_PRODUCTS = {
            "fashion": [
                ...
                {"id": "fb_fashion_6",  "name": "New Balance 574 Core Sneakers",           "brand": "New Balance", "price": 39000, "description": "Heritage lifestyle sneaker with suede and mesh upper."},
                {"id": "fb_fashion_7",  "name": "Reebok Classic Leather Sneakers",         "brand": "Reebok",      "price": 35000, "description": "Timeless leather sneaker that goes with everything."},
                {"id": "fb_fashion_8",  "name": "Converse Chuck Taylor All Star High-Top", "brand": "Converse",    "price": 28000, "description": "Iconic canvas high-top sneaker beloved by students and creatives."},
                {"id": "fb_fashion_9",  "name": "Ankara Print Kimono Jacket",              "brand": "Local Craft", "price": 15000, "description": "Vibrant African print kimono jacket. Perfect for owambe and casual looks."},
            ...
            "restaurants": [
                ...
                {"id": "fb_rest_10", "name": "Ocean Basket Fish and Chips",              "brand": "Ocean Basket",       "price": 16500, "description": "Crispy calamari with fish and chips."},
            ],
        }
